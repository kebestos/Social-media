...
public class InterestChoice extends AppCompatActivity {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(listChoiceInterest.size() > 0){
                    ...
                    Intent intHome = new Intent(InterestChoice.this, Accueil.class);
                    startActivity(intHome);
                }
                else{
                    Toast.makeText(InterestChoice.this, "Choisissez au moins un intérêt",
    ...
    private void VerifyInterestPreChoice() {
        mDatabase.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0){
                    Map<String,Object> map = (Map<String, Object>) dataSnapshot.getValue();
                    if(map.get("interets")!=null){
                        //Log.d("test","move to Accueil From interest");
                        Intent intHome = new Intent(InterestChoice.this, Accueil.class);
                        startActivity(intHome);
                    }
                }
